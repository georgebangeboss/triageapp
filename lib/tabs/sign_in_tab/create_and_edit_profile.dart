...
class _CreateEditProfileState extends State<CreateEditProfile> {
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                                        ...
                                        TextSpan(
                                          ...
                                          recognizer: TapGestureRecognizer()
                                            ..onTap = () async {
                                              ...
                                              setState(() {
                                                checkedTermsAndConditions = result;
                                              });
                                            },
                                          style: TextStyle(
                                            fontSize: 15.0,
                    ...
                    buildErrorPane(showErrorPane,checkedTermsAndConditions,isSaveChangesSignInButtonPressed,isEditPage),
                    SizedBox(
                      height : 5,
                    ),
                    Center(
                        ...
                        onPressed: () {
                          ...
                          if (_formKey.currentState.validate()) {
                            ...
                            if (isEditPage) {
                              ...
                              Provider.of<Tenant>(context,listen: false).updateTenant(newTenant);
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) {
                                    return MainPage(newTenant);
                                  },
                                ),
                              );
                            } else {
  ...
  Widget buildErrorPane(bool isNotFilledError,bool isChecked,bool isButtonPressed,bool isEditPage) {
    if(isNotFilledError && !isChecked && isButtonPressed && !isEditPage){
      return ErrorPane('Fill all the required fields and agree to the terms & conditions');
