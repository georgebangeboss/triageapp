...
class Palette {
  static final Color primaryColor = Color(0xffc32148);
  static final Color greyColor = Colors.grey;
  static final Color primaryTextColor = Colors.black54;
  ...
  static Color scaffoldBackground=Colors.grey[200];
  static Color paymentCardColor=Colors.white;
  static Color primaryBackground=Color(0xffc32148);
  static Color buttonBackGround=Color(0xffBD9522);
